<footer id="colophon" class="site-footer">
    <div class="container">
        <div class="site-info">
            <h1 style="font-family: 'Herr Von Muellerhoff';color: #ccc;font-weight:300;
            text-align: center;margin-bottom:0;margin-top:0;
            line-height:1.4;font-size: 46px;">Diccount</h1>
            made by <i class="fa fa-love"></i><a href="https://github.com/codingchild1">Kim-SangWon</a>
            <%--diaryAccount--%>
        </div>
    </div>
</footer>
